...
C_SRCS += \
F:\eclipse\arduinoPlugin\packages\adafruit\hardware\samd\1.6.4\cores\arduino\TinyUSB\Adafruit_TinyUSB_ArduinoCore\tinyusb\src\class\dfu\dfu_rt_device.c 

C_DEPS += \
.\core\core\TinyUSB\Adafruit_TinyUSB_ArduinoCore\tinyusb\src\class\dfu\dfu_rt_device.c.d 

AR_OBJ += \
.\core\core\TinyUSB\Adafruit_TinyUSB_ArduinoCore\tinyusb\src\class\dfu\dfu_rt_device.c.o 


# Each subdirectory must supply rules for building sources it contributes
core\core\TinyUSB\Adafruit_TinyUSB_ArduinoCore\tinyusb\src\class\dfu\dfu_rt_device.c.o: F:\eclipse\arduinoPlugin\packages\adafruit\hardware\samd\1.6.4\cores\arduino\TinyUSB\Adafruit_TinyUSB_ArduinoCore\tinyusb\src\class\dfu\dfu_rt_device.c
	@echo 'Building file: $<'
